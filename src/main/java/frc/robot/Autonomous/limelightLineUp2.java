...
public class limelightLineUp2 {
	...
	public limelightLineUp2(TorDrive drive, double minimalTime, double timeOutTime) {
		this.drive = drive;
	...
	public void run() {
		...
		case GO:
			NetworkTableInstance.getDefault().getTable("limelight").getEntry("ledMode").setNumber(3);
            angleError = (tx.getDouble(0.0) - 3.0) * Math.PI / 180.0;
